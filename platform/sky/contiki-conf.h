...
#define CONTIKIMAC_CONF_CCA_CHECK_TIME      RTIMER_ARCH_SECOND / 8192

#if RTIMER_ARCH_SECOND > 8000
#define CONTIKIMAC_CONF_CCA_SLEEP_TIME                     RTIMER_ARCH_SECOND /2000 //2000
#else
#define CONTIKIMAC_CONF_CCA_SLEEP_TIME                     (RTIMER_ARCH_SECOND / 2000) + 1
#endif /* RTIMER_ARCH_SECOND > 8000 */

#define CONTIKIMAC_CONF_INTER_PACKET_INTERVAL              RTIMER_ARCH_SECOND / 2500//2500
...
#define RPL_MOP_DOWNWARD_STORING   1
#endif
...
/* Specify a minimum packet size for 6lowpan compression to be
   ...
   used. */
#define SICSLOWPAN_CONF_COMPRESSION_THRESHOLD 78  //63
